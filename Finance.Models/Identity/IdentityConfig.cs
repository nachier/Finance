...
namespace Finance.Models.Identity
{
    ...
    public class ApplicationRoleManager:RoleManager<ApplicationRole,int>
    {
        ...
        {
             return  new ApplicationRoleManager(new ApplicationRoleStore(context.Get<FinanceDB>()));          
        }
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser,int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new ApplicationUserStore(context.Get<FinanceDB>()));
            // 配置用户名的验证逻辑
