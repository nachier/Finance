...
namespace FinanceSystem
{
    ...
    public class ApplicationRoleManager:RoleManager<ApplicationRole,int>
    {
        ...
        {
             return  new ApplicationRoleManager(new ApplicationRoleStore(context.Get<FinanceSystemDB>()));          
        }
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser,int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new ApplicationUserStore(context.Get<FinanceSystemDB>()));
            // 配置用户名的验证逻辑
