...
namespace FinanceSystem.Models
{
    ...
    public class FinanceSystemDB : IdentityDbContext<ApplicationUser, ApplicationRole, int, ApplicationUserLogin, ApplicationUserRole, ApplicationUserCliam>
    {
        public FinanceSystemDB()
            : base("FinanceSystemDB")
        {

        }

        public static FinanceSystemDB Create()
        {
            return new FinanceSystemDB();
        }
